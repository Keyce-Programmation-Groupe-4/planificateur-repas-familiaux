"use client"
import { Paper, Typography, Stack, Box, useTheme, Skeleton, alpha, Fade, Zoom } from "@mui/material"
import MealSlot from "./MealSlot"
import { isSameDay, isValid } from "date-fns"

function DayColumn({ dayName, dayKey, meals, recipes, onOpenModal, onDeleteRecipe, currentDate, weekStartDate }) {
    ...
    <Zoom in timeout={400}>
      <Paper
        ...
        sx={{
          ...
          height: "100%",
          minHeight: "450px", // Hauteur fixe pour cohérence
          background: isToday
